...
#ifndef QRCODESCANNER_SWIFT_H
#define QRCODESCANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QRCodeScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13QRCodeScanner11AppDelegate")
...
SWIFT_CLASS("_TtC13QRCodeScanner11CustomLabel")
...
SWIFT_CLASS("_TtC13QRCodeScanner15MainCoordinator")
...
SWIFT_CLASS("_TtC13QRCodeScanner28ScanningScreenViewController")
@interface ScanningScreenViewController : UIViewController
- (void)viewDidLoad;
- (void)windBack;
...
SWIFT_CLASS("_TtC13QRCodeScanner13SceneDelegate")
...
SWIFT_CLASS("_TtC13QRCodeScanner22StartingViewController")
